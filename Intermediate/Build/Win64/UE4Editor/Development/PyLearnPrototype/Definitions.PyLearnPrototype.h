...
#define UE_PROJECT_NAME PyLearnPrototype
#define UE_TARGET_NAME PyLearnPrototypeEditor
#define UE_MODULE_NAME "PyLearnPrototype"
...
#define PYLEARNPROTOTYPE_API DLLEXPORT
