...
#include "PyLearnPrototype/FloorSwitch.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	PYLEARNPROTOTYPE_API UClass* Z_Construct_UClass_AFloorSwitch_NoRegister();
	PYLEARNPROTOTYPE_API UClass* Z_Construct_UClass_AFloorSwitch();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloorSwitch_Statics::NewProp_InitialSwitchLocation_MetaData[] = {
		{ "Category", "Floor Switch" },
		{ "Comment", "// initial location of switch\n" },
		{ "ModuleRelativePath", "FloorSwitch.h" },
		{ "ToolTip", "initial location of switch" },
	};
#endif
	...
	IMPLEMENT_CLASS(AFloorSwitch, 22401387);
	template<> PYLEARNPROTOTYPE_API UClass* StaticClass<AFloorSwitch>()
	{
		return AFloorSwitch::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AFloorSwitch(Z_Construct_UClass_AFloorSwitch, &AFloorSwitch::StaticClass, TEXT("/Script/PyLearnPrototype"), TEXT("AFloorSwitch"), false, nullptr, nullptr, nullptr);
